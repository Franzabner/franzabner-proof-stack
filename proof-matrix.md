...
| Lane | Planned proof source | Artifact type | Current status | Boundary note | Review need |
| --- | --- | --- | --- | --- | --- |
...
| Agents | `autonomous-engineering-harness` | synthetic harness docs | Planned | No YAi/YOSOTRON internals. | architecture review |
| AI workflows | `ai-assisted-engineering-workflows` | workflow checklists | Planned | No internal prompts or customer workflows. | boundary review |
| EPI/HF | `epi-research-roadmap`, `hf-card-templates` | release templates and roadmap | Planned | No fake weights, datasets, Spaces, or results. | release review |
