...
|---|---|---|
| Risky production-adjacent repos | rack, agent, Fusion, KiCad production, production RIB, private infrastructure lanes | Need boundary review or derivative-only planning before linking as proof. Fine-tuning lab notes now route through `fine-tuning-lab-notes`; any additional fine-tuning or evaluation derivative remains held until review. |
